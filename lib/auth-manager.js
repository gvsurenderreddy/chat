...
module.exports = {
	 ...
	 * @param {function} callback - The function to call after the check has been carried out.
	 */
	 ...
	 * @param {string} token - The user's authentication token.
	 * @param {function} callback - The function to call after the check has been carried out (called with following params : extras, err).
	 */
